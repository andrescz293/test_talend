...
package local_project.req_06_migracion_nexis_facturacion_0_1;
...
/**
 * Job: REQ_06_migracion_nexis_facturacion Purpose: REQ_06_migracion_nexis_facturacion<br>
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(REQ_06_migracion_nexis_facturacion.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tExtractXMLField_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row31Struct implements routines.system.IPersistableRow<row31Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion.length == 0) {
   					commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_REQ_06_migracion_nexis_facturacion) {
...
org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/xml/jobs/job"));  
...
java.util.Map<Integer,org.dom4j.XPath> xpaths_tFileInputXML_1=new java.util.HashMap<Integer,org.dom4j.XPath>();
	...
	org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("@name","/xml/jobs/job"));
	xpath_0.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(0,xpath_0);
			
	org.dom4j.XPath xpath_1 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("subcompanys","/xml/jobs/job"));
	xpath_1.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(1,xpath_1);
			
	org.dom4j.XPath xpath_2 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("@folder_root","/xml/jobs/job"));
 ...
 */
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");    
        ope_tFilterRow_1.matches((row25.name == null? false : row25.name.matches((String)globalMap.get("job_name")) == true)
...
row31 = null;
    ...
    try{
    	...
    	nodeList_tExtractXMLField_1 = (java.util.List<org.dom4j.Node>)x_tExtractXMLField_1.selectNodes(doc_tExtractXMLField_1);
    ...
    for(int i_tExtractXMLField_1=0; isStructError_tExtractXMLField_1 || (nodeList_tExtractXMLField_1!=null && i_tExtractXMLField_1 < nodeList_tExtractXMLField_1.size());i_tExtractXMLField_1++){
    	...
    	if(!isStructError_tExtractXMLField_1){
    		...
    		org.dom4j.Node temp_tExtractXMLField_1 = nodeList_tExtractXMLField_1.get(i_tExtractXMLField_1);
	
	    	nb_line_tExtractXMLField_1++;	
			try{
				org.dom4j.XPath xTmp0_tExtractXMLField_1 = temp_tExtractXMLField_1.createXPath(nsTool_tExtractXMLField_1.addDefaultNSPrefix("variables",loopQuery_tExtractXMLField_1));
...
row33 = null;
    ...
    try{
	    	...
	    	doc_tExtractXMLField_2= reader_tExtractXMLField_2.read(new java.io.StringReader(xmlStr_tExtractXMLField_2));
    	...
    	x_tExtractXMLField_2 = doc_tExtractXMLField_2.createXPath(nsTool_tExtractXMLField_2.addDefaultNSPrefix(loopQuery_tExtractXMLField_2,loopQuery_tExtractXMLField_2));
      
    	x_tExtractXMLField_2.setNamespaceURIs(xmlNameSpaceMap_tExtractXMLField_2); 
    
		 
    	nodeList_tExtractXMLField_2 = (java.util.List<org.dom4j.Node>)x_tExtractXMLField_2.selectNodes(doc_tExtractXMLField_2);
    ...
    for(int i_tExtractXMLField_2=0; isStructError_tExtractXMLField_2 || (nodeList_tExtractXMLField_2!=null && i_tExtractXMLField_2 < nodeList_tExtractXMLField_2.size());i_tExtractXMLField_2++){
    	
    	if(!isStructError_tExtractXMLField_2){
			row33 = null;
    		row33 = new row33Struct();
    	
    		org.dom4j.Node temp_tExtractXMLField_2 = nodeList_tExtractXMLField_2.get(i_tExtractXMLField_2);
	
	    	nb_line_tExtractXMLField_2++;	
			try{
				org.dom4j.XPath xTmp0_tExtractXMLField_2 = temp_tExtractXMLField_2.createXPath(nsTool_tExtractXMLField_2.addDefaultNSPrefix(".",loopQuery_tExtractXMLField_2));
			    xTmp0_tExtractXMLField_2.setNamespaceURIs(xmlNameSpaceMap_tExtractXMLField_2);
				
			    Object obj0_tExtractXMLField_2 = xTmp0_tExtractXMLField_2.evaluate(temp_tExtractXMLField_2);
			    if(obj0_tExtractXMLField_2 instanceof String || obj0_tExtractXMLField_2 instanceof Number){
				    ...
				    node_tExtractXMLField_2 = xTmp0_tExtractXMLField_2.selectSingleNode(temp_tExtractXMLField_2);
				    str_tExtractXMLField_2 = xTmp0_tExtractXMLField_2.valueOf(temp_tExtractXMLField_2);
				}
									if(resultIsNode_tExtractXMLField_2 && xml_api_tExtractXMLField_2.isDefNull(node_tExtractXMLField_2)){
											row33.value =null;
									}else if(resultIsNode_tExtractXMLField_2 && xml_api_tExtractXMLField_2.isEmpty(node_tExtractXMLField_2)){
										row33.value ="";
									}else if(resultIsNode_tExtractXMLField_2 && xml_api_tExtractXMLField_2.isMissing(node_tExtractXMLField_2 )){ 
										row33.value =null;
									}else{
				row33.value = str_tExtractXMLField_2;
									}
				org.dom4j.XPath xTmp1_tExtractXMLField_2 = temp_tExtractXMLField_2.createXPath(nsTool_tExtractXMLField_2.addDefaultNSPrefix("@id",loopQuery_tExtractXMLField_2));
			    xTmp1_tExtractXMLField_2.setNamespaceURIs(xmlNameSpaceMap_tExtractXMLField_2);
				
			    Object obj1_tExtractXMLField_2 = xTmp1_tExtractXMLField_2.evaluate(temp_tExtractXMLField_2);
			    if(obj1_tExtractXMLField_2 instanceof String || obj1_tExtractXMLField_2 instanceof Number){
			    	resultIsNode_tExtractXMLField_2 = false;
    				str_tExtractXMLField_2 = String.valueOf(obj1_tExtractXMLField_2);
   				}else{
   					resultIsNode_tExtractXMLField_2 = true;
				    node_tExtractXMLField_2 = xTmp1_tExtractXMLField_2.selectSingleNode(temp_tExtractXMLField_2);
				    str_tExtractXMLField_2 = xTmp1_tExtractXMLField_2.valueOf(temp_tExtractXMLField_2);
				}
									if(resultIsNode_tExtractXMLField_2 && xml_api_tExtractXMLField_2.isDefNull(node_tExtractXMLField_2)){
											row33.id =null;
									}else if(resultIsNode_tExtractXMLField_2 && xml_api_tExtractXMLField_2.isEmpty(node_tExtractXMLField_2)){
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_3";
		...
		}else if (properties_tDBConnection_3 != null && !properties_tDBConnection_3.contains("rewriteBatchedStatements")) {
			properties_tDBConnection_3 += "&rewriteBatchedStatements=true";
		}
		if (properties_tDBConnection_3 != null && !properties_tDBConnection_3.contains("allowLoadLocalInfile")) {
			properties_tDBConnection_3 += "&allowLoadLocalInfile=true";
		}
		
		String url_tDBConnection_3 = "jdbc:mariadb://" + (String)globalMap.get("var_host_origen_mysql") + ":" + (String)globalMap.get("var_port_origen_mysql") + "/" + (String)globalMap.get("var_database_origen_mysql") + "?" + properties_tDBConnection_3;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
		...
		int tos_count_tDBConnection_2 = 0;
            ...
            String url_tDBConnection_2 = "jdbc:postgresql://"+(String)globalMap.get("var_host_destino_psql")+":"+(String)globalMap.get("var_port_destino_psql")+"/"+(String)globalMap.get("var_database_destino_psql");
...
public void tMongoDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    java.util.List<com.mongodb.MongoCredential> mongoCredentialList_tMongoDBConnection_1 = new java.util.ArrayList<com.mongodb.MongoCredential>();
        ...
        com.mongodb.ServerAddress serverAddress_tMongoDBConnection_1 = new com.mongodb.ServerAddress((String)globalMap.get("var_host_mongo"), conversion.getPortGrupollano(globalMap ));
    ...
    mongo_tMongoDBConnection_1.getAddress() ;
		com.mongodb.client.MongoDatabase db_tMongoDBConnection_1 = ((com.mongodb.MongoClient)mongo_tMongoDBConnection_1).getDatabase((String)globalMap.get("var_database_mongo"));
...
public void tFixedFlowInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	int nb_line_tMongoDBOutput_2 = 0;
			...
			com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_2 = db_tMongoDBOutput_2.getCollection((String)globalMap.get("var_coleccion_mongo"));
...
try{
				updateObjectUtil_tMongoDBOutput_2.setObject(new org.bson.Document());
	                            ...
	                            if (row4.id_proceso_dimension != null) {
                                    ...
                                    updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("id_proceso_dimension"),"id_proceso_dimension", row4.id_proceso_dimension);
	                            }
	                            if (row4.fecha_inicio != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("fecha_inicio"),"fecha_inicio", row4.fecha_inicio);
	                            }
                                updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("finalizado"),"finalizado", row4.finalizado);
	                            if (row4.guid != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("guid"),"guid", row4.guid);
	                            }
                                updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("tdestino"),"tdestino", row4.tdestino);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ((String)globalMap.get("var_tabla_destino_psql"));
}
...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_facturacion\" INT4  not null ,\"codigodataease\" VARCHAR(20)  ,\"numerofactura\" INT4 ,\"idconcepto\" VARCHAR(3)  ,\"valor\" FLOAT8 ,\"saldo\" FLOAT8 ,\"tipoliquidacion\" VARCHAR(20)  ,\"empresahomologada\" VARCHAR(20)  ,\"codigohomologado\" VARCHAR(20)  ,\"idtipouso\" VARCHAR(30)  ,\"estrato\" VARCHAR(20)  ,\"tipproductor\" INT4 ,\"idliquidacion\" VARCHAR(50)  ,\"tercero\" VARCHAR(250)  ,\"ciclo\" VARCHAR(5)  ,\"periodo\" VARCHAR(6)  ,\"fechafactura\" DATE ,\"fechavencimiento\" DATE ,\"tipoaforo\" VARCHAR(20)  ,\"usuarioregistro\" VARCHAR(150)  ,primary key(\"id_facturacion\"))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"id_facturacion\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_facturacion\",\"codigodataease\",\"numerofactura\",\"idconcepto\",\"valor\",\"saldo\",\"tipoliquidacion\",\"empresahomologada\",\"codigohomologado\",\"idtipouso\",\"estrato\",\"tipproductor\",\"idliquidacion\",\"tercero\",\"ciclo\",\"periodo\",\"fechafactura\",\"fechavencimiento\",\"tipoaforo\",\"usuarioregistro\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"codigodataease\" = ?,\"numerofactura\" = ?,\"idconcepto\" = ?,\"valor\" = ?,\"saldo\" = ?,\"tipoliquidacion\" = ?,\"empresahomologada\" = ?,\"codigohomologado\" = ?,\"idtipouso\" = ?,\"estrato\" = ?,\"tipproductor\" = ?,\"idliquidacion\" = ?,\"tercero\" = ?,\"ciclo\" = ?,\"periodo\" = ?,\"fechafactura\" = ?,\"fechavencimiento\" = ?,\"tipoaforo\" = ?,\"usuarioregistro\" = ? WHERE \"id_facturacion\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM etl_facturacion WHERE "+(String)globalMap.get("var_query_where_sentence");
...
} else {pstmtUpdate_tDBOutput_1.setString(18, row1.TipAforo);
}

                        if(row1.UsuarioRegistro == null) {
pstmtUpdate_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(19, row1.UsuarioRegistro);
}
...
} else {pstmtInsert_tDBOutput_1.setString(2, row1.CodigoDataease);
}

                        if(row1.NumeroFactura == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, row1.NumeroFactura);
}

                        if(row1.IdConcepto == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, row1.IdConcepto);
}

                        if(row1.Valor == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(5, row1.Valor);
}

                        if(row1.Saldo == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(6, row1.Saldo);
}

                        if(row1.TipoLiquidacion == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, row1.TipoLiquidacion);
}

                        if(row1.EmpresaHomologada == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, row1.EmpresaHomologada);
}

                        if(row1.CodigoHomologado == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(9, row1.CodigoHomologado);
}

                        if(row1.IdTipoUso == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(10, row1.IdTipoUso);
}

                        if(row1.Estrato == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, row1.Estrato);
}

                        if(row1.TipoGenerador == null) {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(12, row1.TipoGenerador);
}

                        if(row1.IdLiquidacion == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(13, row1.IdLiquidacion);
}

                        if(row1.Tercero == null) {
pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(14, row1.Tercero);
}

                        if(row1.Ciclo == null) {
pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(15, row1.Ciclo);
}

                        if(row1.Periodo == null) {
pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(16, row1.Periodo);
}

                        if(row1.FechaFactura != null) {
pstmtInsert_tDBOutput_1.setTimestamp(17, new java.sql.Timestamp(row1.FechaFactura.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.TIMESTAMP);
}

                        if(row1.FechaVencimiento != null) {
pstmtInsert_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(row1.FechaVencimiento.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(19, row1.TipAforo);
}

                        if(row1.UsuarioRegistro == null) {
pstmtInsert_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(20, row1.UsuarioRegistro);
}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.id_proceso_dimension == null) ? 0 : this.id_proceso_dimension.hashCode());
...
public void tFixedFlowInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	int nb_line_tMongoDBOutput_3 = 0;
			...
			com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_3 = db_tMongoDBOutput_3.getCollection((String)globalMap.get("var_coleccion_mongo"));
				...
				updateObjectUtil_tMongoDBOutput_3.setObject(new org.bson.Document());
					...
					int countKey_tMongoDBOutput_3=0;
	                            ...
	                            if (row6.id_proceso_dimension != null) {
    	                                    ...
    	                                    queryObjectUtil_tMongoDBOutput_3.putkeyNode(pathMap_tMongoDBOutput_3.get("id_proceso_dimension"),"id_proceso_dimension", row6.id_proceso_dimension);
    	                                    countKey_tMongoDBOutput_3++;
    	                                
                                    updateObjectUtil_tMongoDBOutput_3.put(pathMap_tMongoDBOutput_3.get("id_proceso_dimension"),"id_proceso_dimension", row6.id_proceso_dimension);
	                            }
                                updateObjectUtil_tMongoDBOutput_3.put(pathMap_tMongoDBOutput_3.get("registros_insertados"),"registros_insertados", row6.registros_insertados);
                                updateObjectUtil_tMongoDBOutput_3.put(pathMap_tMongoDBOutput_3.get("registros_actualizados"),"registros_actualizados", row6.registros_actualizados);
	                            if (row6.registros__rechazados != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_3.put(pathMap_tMongoDBOutput_3.get("registros__rechazados"),"registros__rechazados", row6.registros__rechazados);
	                            }
	                            if (row6.guid != null) {
    	                            
    	                                    queryObjectUtil_tMongoDBOutput_3.putkeyNode(pathMap_tMongoDBOutput_3.get("guid"),"guid", row6.guid);
    	                                    countKey_tMongoDBOutput_3++;
    	                                
                                    updateObjectUtil_tMongoDBOutput_3.put(pathMap_tMongoDBOutput_3.get("guid"),"guid", row6.guid);
	                            }
				org.bson.Document updateObj_tMongoDBOutput_3 = updateObjectUtil_tMongoDBOutput_3.getObject();
					...
					if(countKey_tMongoDBOutput_3 <=0){
						...
						org.bson.Document queryObj_tMongoDBOutput_3 = queryObjectUtil_tMongoDBOutput_3.getObject();
                                ...
                                coll_tMongoDBOutput_3.updateOne(queryObj_tMongoDBOutput_3,new org.bson.Document("$set", updateObj_tMongoDBOutput_3),new com.mongodb.client.model.UpdateOptions().upsert(true));
					}
...
public void tFixedFlowInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	int nb_line_tMongoDBOutput_1 = 0;
			...
			com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection((String)globalMap.get("var_coleccion_mongo"));
				...
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
					...
					int countKey_tMongoDBOutput_1=0;
	                            ...
	                            if (row5.id_proceso_dimension != null) {
    	                                    ...
    	                                    queryObjectUtil_tMongoDBOutput_1.putkeyNode(pathMap_tMongoDBOutput_1.get("id_proceso_dimension"),"id_proceso_dimension", row5.id_proceso_dimension);
    	                                    countKey_tMongoDBOutput_1++;
    	                                
                                    updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("id_proceso_dimension"),"id_proceso_dimension", row5.id_proceso_dimension);
	                            }
	                            if (row5.fecha_finalizacion != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("fecha_finalizacion"),"fecha_finalizacion", row5.fecha_finalizacion);
	                            }
	                            if (row5.registros_input != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("registros_input"),"registros_input", row5.registros_input);
	                            }
                                updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("registros_insertados"),"registros_insertados", row5.registros_insertados);
                                updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("registros_actualizados"),"registros_actualizados", row5.registros_actualizados);
                                updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("finalizado"),"finalizado", row5.finalizado);
	                            if (row5.registros__rechazados != null) {
    	                            
                                    updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("registros__rechazados"),"registros__rechazados", row5.registros__rechazados);
	                            }
	                            if (row5.guid != null) {
    	                            
    	                                    queryObjectUtil_tMongoDBOutput_1.putkeyNode(pathMap_tMongoDBOutput_1.get("guid"),"guid", row5.guid);
    	                                    countKey_tMongoDBOutput_1++;
    	                                
                                    updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("guid"),"guid", row5.guid);
	                            }
				org.bson.Document updateObj_tMongoDBOutput_1 = updateObjectUtil_tMongoDBOutput_1.getObject();
					...
					if(countKey_tMongoDBOutput_1 <=0){
						...
						org.bson.Document queryObj_tMongoDBOutput_1 = queryObjectUtil_tMongoDBOutput_1.getObject();
                                ...
                                coll_tMongoDBOutput_1.updateOne(queryObj_tMongoDBOutput_1,new org.bson.Document("$set", updateObj_tMongoDBOutput_1),new com.mongodb.client.model.UpdateOptions().upsert(true));
					}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = REQ_06_migracion_nexis_facturacion.class.getClassLoader().getResourceAsStream("local_project/req_06_migracion_nexis_facturacion_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = REQ_06_migracion_nexis_facturacion.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : REQ_06_migracion_nexis_facturacion");
        }
...
/************************************************************************************************
 *     295445 characters generated by Talend Open Studio for Big Data 
 *     on the 19 de abril de 2023 09:42:26 AM COT
 ************************************************************************************************/